...
jQuery(document).ready(function() {
    ...
    $('form .btn-next').on('click', function() {
    	...
    	parent_fieldset.find('input[type="text"],input[type="date"], input[type="password"], input[type="username"], input[type="email"], input[type="tel"], input[type="url"], textarea').each(function() {
    		if( $(this).val() == "" ) {
    			$(this).addClass('input-error');
					console.log("si llega a la parte donde da error");
    			next_step = false;
    		}
    		else {
    			$(this).removeClass('input-error');
